    ...
    >
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.imageContainer}>
          <Image
            source={require('../../assets/onboard_2.png')}
        ...
        >
          <Text style={styles.title}>Discover Earth's Star Destinations</Text>
          <Text style={styles.desc}>
            Explore deserts, mountains, islands, and distant landscapes where the sky feels wider
            and the constellations seem closer. Each place carries its own cosmic atmosphere,
            shaped by dark horizons, observatories, and stories written beneath the stars
          </Text>
